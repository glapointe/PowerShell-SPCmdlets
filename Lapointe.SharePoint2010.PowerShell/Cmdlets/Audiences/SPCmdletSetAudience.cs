...
{
    [Cmdlet(VerbsCommon.Set, "SPAudience", SupportsShouldProcess = false),
    ...
    [Example(Code = "PS C:\\> Set-SPAudience -UserProfileServiceApplication \"30daa535-b0fe-4d10-84b0-fb04029d161a\" -Identity \"Human Resources\" -Membership Any -Owner domain\\user -Description \"All members of the Human Resources department.\"",
        Remarks = "This example updates the audience named \"Human Resources\" in the user profile service application with ID \"30daa535-b0fe-4d10-84b0-fb04029d161a\".")]
    [RelatedCmdlets(
        typeof(SPCmdletNewAudienceRule), typeof(SPCmdletNewAudience),
        ExternalCmdlets = new[] { "Get-SPServiceApplication" })]
    public class SPCmdletSetAudience : SPSetCmdletBaseCustom<Audience>
    {
