...
Start-Process "C:\Program Files (x86)\Microsoft SDKs\Windows\v8.0A\bin\NETFX 4.0 Tools\gacutil.exe" -ArgumentList "/uf","Lapointe.PowerShell.MamlGenerator"
Start-Process "C:\Program Files (x86)\Microsoft SDKs\Windows\v8.0A\bin\NETFX 4.0 Tools\gacutil.exe" -ArgumentList "/uf","Lapointe.SharePoint.PowerShell"
